...
//     quote:
//       "Every family deserves a home that reflects their aspirations. At Upscale Bricks, we make that dream a reality.",
//     bio: [
//       "With over 15 years of experience in the real estate industry, I have dedicated my journey to building a company that stands for trust, transparency, and excellence. Holding an MBA in Marketing, I've combined academic knowledge with hands-on expertise to deliver unmatched value to our clients.",
//       "My path in real estate has always been guided by a deep commitment to client satisfaction, market innovation, and lasting relationships. Under my leadership, Upscale Bricks Estates has grown into a trusted name in Bangalore's premium property market — a brand that not only offers homes but curates lifestyle experiences.",
//       "At Upscale Bricks, our vision is simple yet powerful: to transform aspirations into addresses, and to ensure that every client finds not just a property, but a place they can truly call home.",
//     ],
//   },
//   {
...
//             The Visionaries Behind Upscale Bricks
//           </h2>
//           <p className="text-muted-foreground mt-4 max-w-2xl mx-auto leading-relaxed">
//             Guided by experience, driven by passion — meet the founders who are
...
//               className="relative bg-card border border-border rounded-2xl p-8 flex flex-col gap-6 shadow-sm hover:shadow-md transition-shadow duration-300"
//             >
